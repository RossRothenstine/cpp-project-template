...
function(add_linter_tool_to_target)
    set(oneValueArgs TARGET ENABLE ENABLE_CPPCHECK ENABLE_IWYU ENABLE_CLANG_TIDY)
    ...
    if(NOT ${LINTER_ENABLED})
        message("==> Linter Tools Disabled for: ${ADD_LINTER_TOOL_TO_TARGET_TARGET}")
        return()
    endif()

    if(CMAKE_CXX_COMPILER_ID MATCHES "MSVC")
        add_clang_tidy_msvc_to_target(${LINTER_TARGET})
    else()
        get_target_property(TARGET_SOURCES ${LINTER_TARGET} SOURCES)
        list(
            FILTER
            TARGET_SOURCES
            INCLUDE
        ...
        if(LINTER_ENABLE_IWYU)
            if(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
                find_program(INCLUDE_WHAT_YOU_USE include-what-you-use)
                if(INCLUDE_WHAT_YOU_USE)
                    message("==> Added IWYU for Target: ${target}")
                    add_custom_target(
                        ${target}_iwyu
                        COMMAND
                            ${Python3_EXECUTABLE}
